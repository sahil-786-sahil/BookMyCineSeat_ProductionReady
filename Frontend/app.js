...
const API = 'https://bookmycineseat-productionready-1.onrender.com';

/* ════════════════════════════════════════════
   50 REAL-FEEL MOVIES  (local catalogue)
════════════════════════════════════════════ */
const LOCAL_MOVIES = [
  { id:1,  title:'Dune: Part Two',          genre:'Sci-Fi',    language:'English', duration:166, rating:8.5, description:'Paul Atreides unites with Chani and the Fremen while on a warpath of revenge against the conspirators who destroyed his family.',  emoji:'🏜️' },
  { id:2,  title:'Oppenheimer',              genre:'Drama',     language:'English', duration:180, rating:8.9, description:'The story of American scientist J. Robert Oppenheimer and his role in the development of the atomic bomb.', emoji:'☢️' },
  { id:3,  title:'Kalki 2898 AD',            genre:'Action',    language:'Hindi',   duration:181, rating:7.8, description:'Set in the future, the mythological avatar Kalki arrives on Earth to rid it of its ultimate evil.',         emoji:'🤖' },
  { id:4,  title:'Stree 2',                  genre:'Horror',    language:'Hindi',   duration:148, rating:8.2, description:'Chanderi is once again haunted — but this time the terror has a new face and old grudges.',               emoji:'👻' },
  { id:5,  title:'Animal',                   genre:'Action',    language:'Hindi',   duration:201, rating:7.2, description:'A son idolises his father, but the revelation of dark secrets transforms his devotion into obsession.',    emoji:'🐾' },
  { id:6,  title:'12th Fail',                genre:'Drama',     language:'Hindi',   duration:147, rating:9.0, description:'Based on the true story of IPS officer Manoj Kumar Sharma who cleared UPSC despite failing his 12th boards.', emoji:'📚' },
  { id:7,  title:'Pushpa 2: The Rule',       genre:'Action',    language:'Telugu',  duration:185, rating:8.0, description:'Pushpa Raj expands his red sandalwood smuggling empire while confronting a dangerous new rival.',         emoji:'🔥' },
  { id:8,  title:'RRR',                      genre:'Action',    language:'Telugu',  duration:182, rating:7.9, description:'Two legendary revolutionaries and their journey away from home before they started fighting for their country.', emoji:'⚡' },
  { id:9,  title:'Jawan',                    genre:'Thriller',  language:'Hindi',   duration:169, rating:7.0, description:'A man is driven by a personal vendetta to rectify the wrongs in society through a series of daring heists.', emoji:'🎭' },
  { id:10, title:'Pathaan',                  genre:'Action',    language:'Hindi',   duration:146, rating:6.9, description:'An exiled spy must return to save India from a rogue operative hell-bent on revenge.',                   emoji:'🕵️' },
  { id:11, title:'The Batman',               genre:'Action',    language:'English', duration:176, rating:7.8, description:'In his second year of crime-fighting, Batman uncovers corruption in Gotham City that connects to his own family.', emoji:'🦇' },
  { id:12, title:'Top Gun: Maverick',        genre:'Action',    language:'English', duration:130, rating:8.2, description:'After more than thirty years of service, Pete "Maverick" Mitchell is back, pushing the limits as a test pilot.', emoji:'✈️' },
  { id:13, title:'Avatar: The Way of Water', genre:'Sci-Fi',    language:'English', duration:192, rating:7.6, description:'Jake Sully and Ney\'tiri have formed a family and are living in peace until conflict disrupts their life.', emoji:'💙' },
  { id:14, title:'Spider-Man: No Way Home',  genre:'Action',    language:'English', duration:148, rating:8.2, description:'With Spider-Man\'s identity now revealed, Peter asks Doctor Strange for help, unleashing a multiverse crisis.', emoji:'🕷️' },
  { id:15, title:'Interstellar',             genre:'Sci-Fi',    language:'English', duration:169, rating:8.7, description:'A team of explorers travel through a wormhole in space in an attempt to ensure humanity\'s survival.', emoji:'🌌' },
  { id:16, title:'Leo',                      genre:'Thriller',  language:'Tamil',   duration:164, rating:7.1, description:'A mild-mannered coffee shop owner is forced to confront his dangerous past when a drug lord threatens his family.', emoji:'🦁' },
  { id:17, title:'Jailer',                   genre:'Action',    language:'Tamil',   duration:168, rating:7.5, description:'A retired jailer embarks on a brutal rescue mission to save his son from a notorious criminal.',           emoji:'⚓' },
  { id:18, title:'Salaar',                   genre:'Action',    language:'Telugu',  duration:175, rating:6.8, description:'A violent man who promised a friend he would protect his son must keep that vow at any cost.',             emoji:'💀' },
  { id:19, title:'Fighter',                  genre:'Action',    language:'Hindi',   duration:166, rating:6.5, description:'The first aerial action franchise of India follows elite IAF officers on a dangerous cross-border mission.', emoji:'🚀' },
  { id:20, title:'Crew',                     genre:'Comedy',    language:'Hindi',   duration:130, rating:6.8, description:'Three flight attendants get entangled in a shady deal when they discover their airline is going bankrupt.', emoji:'✈️' },
  { id:21, title:'Munjya',                   genre:'Horror',    language:'Hindi',   duration:113, rating:7.2, description:'A young boy accidentally releases a supernatural creature that has been locked away for decades.',          emoji:'😱' },
  { id:22, title:'Kill',                     genre:'Thriller',  language:'Hindi',   duration:105, rating:7.4, description:'An elite commando sets out to rescue his love from kidnappers — on a speeding train.',                  emoji:'🚂' },
  { id:23, title:'Maharaj',                  genre:'Drama',     language:'Hindi',   duration:130, rating:7.0, description:'Based on a 19th-century landmark legal case that shook the foundations of religious power in India.',      emoji:'⚖️' },
  { id:24, title:'Raayan',                   genre:'Action',    language:'Tamil',   duration:158, rating:7.6, description:'A gang leader\'s attempt to free himself from violence is shattered when tragedy strikes his family.',    emoji:'🌊' },
  { id:25, title:'Indian 2',                 genre:'Action',    language:'Tamil',   duration:180, rating:5.9, description:'Senapathy returns to clean up corruption — but discovers the enemy is far closer this time.',            emoji:'🇮🇳' },
  { id:26, title:'Deadpool & Wolverine',     genre:'Action',    language:'English', duration:128, rating:7.8, description:'Deadpool is recruited by the TVA and unwillingly partners with Wolverine to save the multiverse.',       emoji:'🔴' },
  { id:27, title:'Inside Out 2',             genre:'Animation', language:'English', duration:100, rating:7.9, description:'Riley faces new challenges as she enters teenage years — and new emotions arrive to take over Headquarters.', emoji:'🎨' },
  { id:28, title:'Twisters',                 genre:'Action',    language:'English', duration:122, rating:7.0, description:'A storm chaser haunted by a past tragedy returns to the field and must face even more violent storms.',   emoji:'🌪️' },
  { id:29, title:'Alien: Romulus',           genre:'Sci-Fi',    language:'English', duration:119, rating:7.3, description:'A group of young space colonisers face the most terrifying life form in the universe.',                  emoji:'👾' },
  { id:30, title:'Despicable Me 4',          genre:'Animation', language:'English', duration:94,  rating:6.4, description:'Gru and his family are forced to go undercover when a new villain threatens their perfect life.',        emoji:'💛' },
  { id:31, title:'Devara: Part 1',           genre:'Action',    language:'Telugu',  duration:177, rating:7.3, description:'A fearless man of the sea uses fear as a weapon — but his son must now fill impossible shoes.',         emoji:'⚓' },
  { id:32, title:'Singham Again',            genre:'Action',    language:'Hindi',   duration:162, rating:6.7, description:'Bajirao Singham returns to rescue his wife in a crossover of Rohit Shetty\'s cop universe.',            emoji:'👮' },
  { id:33, title:'Bhool Bhulaiyaa 3',        genre:'Horror',    language:'Hindi',   duration:150, rating:7.0, description:'Rooh Baba faces a terrifying supernatural rival who may be the real Manjulika.',                        emoji:'🪔' },
  { id:34, title:'The Wild Robot',           genre:'Animation', language:'English', duration:102, rating:8.3, description:'A robot washed ashore on a wild island must learn to adapt and raises a gosling.',                     emoji:'🤖' },
  { id:35, title:'Joker: Folie à Deux',      genre:'Drama',     language:'English', duration:138, rating:5.5, description:'Arthur Fleck awaits trial and finds love while imprisoned at Arkham State Hospital.',                  emoji:'🃏' },
  { id:36, title:'Vettaiyan',                genre:'Action',    language:'Tamil',   duration:170, rating:7.2, description:'A seasoned cop from a different era faces a modern criminal justice dilemma.',                          emoji:'🔫' },
  { id:37, title:'Amaran',                   genre:'Drama',     language:'Tamil',   duration:167, rating:8.6, description:'The inspiring true story of Major Mukund Varadarajan, one of India\'s bravest soldiers.',              emoji:'🎖️' },
  { id:38, title:'Lucky Baskhar',            genre:'Thriller',  language:'Telugu',  duration:143, rating:8.0, description:'A seemingly ordinary bank employee hides a brilliant criminal mind when his family is threatened.',      emoji:'💰' },
  { id:39, title:'Venom: The Last Dance',    genre:'Action',    language:'English', duration:109, rating:6.0, description:'Eddie Brock and Venom are on the run, pursued by both government agencies and an ancient symbiote god.', emoji:'🕸️' },
  { id:40, title:'Moana 2',                  genre:'Animation', language:'English', duration:100, rating:7.1, description:'Moana embarks on a new, far-flung voyage with her crew across the seas of Oceania.',                  emoji:'🌊' },
  { id:41, title:'Pushpa: The Rise',         genre:'Action',    language:'Telugu',  duration:179, rating:7.6, description:'A laborer rises through the ranks of a red sandalwood smuggling syndicate.',                          emoji:'🌹' },
  { id:42, title:'KGF: Chapter 2',           genre:'Action',    language:'Kannada', duration:168, rating:8.2, description:'Rocky takes control of the Kolar Gold Fields and faces the wrath of both government and rivals.',      emoji:'🪙' },
  { id:43, title:'Doctor Strange MOM',       genre:'Action',    language:'English', duration:126, rating:6.9, description:'Doctor Strange uses the Darkhold to travel the multiverse to protect America Chavez.',                emoji:'🌀' },
  { id:44, title:'Baahubali 2',              genre:'Action',    language:'Telugu',  duration:167, rating:8.2, description:'The conclusion reveals the mystery of why Kattappa killed Baahubali.',                                emoji:'👑' },
  { id:45, title:'Tanhaji',                  genre:'Action',    language:'Hindi',   duration:135, rating:7.6, description:'The untold story of the Maratha warrior Tanhaji Malusare and the battle of Kondhana fort.',            emoji:'⚔️' },
  { id:46, title:'Padmaavat',                genre:'Drama',     language:'Hindi',   duration:164, rating:7.0, description:'The story of Rajput queen Padmavati whose honour is coveted by Sultan Alauddin Khilji.',             emoji:'💎' },
  { id:47, title:'Kantara',                  genre:'Thriller',  language:'Kannada', duration:148, rating:8.5, description:'A peon of the forest department clashes with a tribe\'s tradition and the supernatural forces protecting it.', emoji:'🌿' },
  { id:48, title:'HanuMan',                  genre:'Action',    language:'Telugu',  duration:159, rating:7.5, description:'A small-time thief in Anjanadri gains superpowers from a divine armlet and becomes a hero.',           emoji:'🐒' },
  { id:49, title:'Varisu',                   genre:'Drama',     language:'Tamil',   duration:167, rating:6.2, description:'A carefree son must step up to save his father\'s business empire from a powerful rival.',             emoji:'🏛️' },
  { id:50, title:'Dunki',                    genre:'Drama',     language:'Hindi',   duration:161, rating:6.8, description:'Friends embark on a perilous illegal immigration journey to reach their dream country.',               emoji:'🌍' },
  { id:51, title:'Sam Bahadur',              genre:'Drama',     language:'Hindi',   duration:155, rating:7.8, description:'The biopic of Field Marshal Sam Manekshaw, India\'s most celebrated war hero.',                      emoji:'🎖️' },
  { id:52, title:'Merry Christmas',          genre:'Thriller',  language:'Hindi',   duration:130, rating:7.0, description:'A chance meeting on Christmas Eve draws two strangers into a web of murder and deception.',           emoji:'🎄' },
  { id:53, title:'Shaitaan',                 genre:'Horror',    language:'Hindi',   duration:132, rating:7.2, description:'A family vacation turns into a nightmare when a stranger with dark powers enters their lives.',        emoji:'😈' },
  { id:54, title:'Yodha',                    genre:'Action',    language:'Hindi',   duration:126, rating:6.0, description:'An army officer must single-handedly stop a plane hijacking at 30,000 feet.',                        emoji:'🛩️' },
  { id:55, title:'Bade Miyan Chote Miyan',   genre:'Action',    language:'Hindi',   duration:157, rating:4.8, description:'Two rogue soldiers with different approaches team up to stop a catastrophic terrorist plot.',         emoji:'💣' },
];
...
async function handleLogin(e) {
  ...
  try {
    ...
    let friendly = err.message || 'Login failed';
    if (err.status === 401 || friendly.toLowerCase().includes('bad credentials') ||
        friendly.toLowerCase().includes('unauthorized') ||
        friendly.toLowerCase().includes('invalid'))
      friendly = 'Wrong email or password. Please try again.';
    if (err.status === 404)
      friendly = 'Account not found. Please register first.';
    if (err.status === 0 || friendly.includes('fetch') || friendly.includes('network'))
